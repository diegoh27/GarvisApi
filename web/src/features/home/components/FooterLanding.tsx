			...
			<div className="relative mx-auto w-full max-w-7xl px-6 py-14 lg:px-12">
				...
				<div className="mb-10 overflow-hidden rounded-3xl bg-white/70 p-6 shadow-xl ring-1 ring-[#99F6E4]/40 backdrop-blur md:p-10">
					<div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
						<div>
							<p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0E7490]/80">
								Listo para tu cita
							</p>
						...
						<div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
							<Link
								to="/disponibilidad"
								className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#14B8A6] to-[#0E7490] px-6 py-3 text-sm font-semibold text-white shadow-md shadow-teal-500/25 transition-all hover:-translate-y-0.5 hover:shadow-lg"
							>
								Ver disponibilidad
							</Link>
							<a
								href="#contactanos"
								className="inline-flex items-center justify-center rounded-full border border-[#14B8A6]/40 bg-white/80 px-6 py-3 text-sm font-semibold text-[#0E7490] shadow-sm transition-colors hover:bg-[#F0FDFA]"
							>
								Contáctanos
							</a>
						</div>
				...
				<div className="grid gap-10 md:grid-cols-4">
					<div className="md:col-span-2">
						<div className="flex items-center gap-3">
							...
							/>
							<div>
								<p className="text-sm font-semibold text-slate-800">Unidad de Ecografía Garbis</p>
								<p className="text-xs text-slate-500">Diagnóstico por imágenes · Maracay</p>
							</div>
						</div>
					...
					<div>
						<p className="text-sm font-bold text-slate-800">Secciones</p>
					...
					<div>
						<p className="text-sm font-bold text-slate-800">Contacto</p>
						<ul className="mt-4 space-y-3 text-sm text-slate-600">
							<li>
								<a
				...
				<div className="mt-10 flex flex-col gap-3 border-t border-[#99F6E4]/40 pt-6 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">

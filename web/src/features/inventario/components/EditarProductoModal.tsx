...
import { useUpdateProductoMutation } from "../../productos/productosApi";
...
const EditarProductoModal = ({ producto, onClose, onSuccess }: EditarProductoModalProps) => {
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
			<div className="relative w-full max-w-md rounded-xl bg-paper shadow-lg">
				<div className="flex items-center justify-between border-b border-mist p-4">
					<h2 className="text-lg font-semibold text-brand-900">Editar producto</h2>
					<button
						onClick={onClose}
				...
				<form onSubmit={handleSubmit} className="space-y-4 p-6">
					<div>
						<label htmlFor="editar-nombre" className="mb-1 block text-sm font-medium text-brand-800">
					...
					<div>
						<label htmlFor="editar-unidad" className="mb-1 block text-sm font-medium text-brand-800">
					...
					<div className="grid grid-cols-2 gap-4">
						<div>
							<label htmlFor="editar-stock_minimo" className="mb-1 block text-sm font-medium text-brand-800">
								Stock mínimo
							</label>
							<input
						...
						<div>
							<label htmlFor="editar-precio" className="mb-1 block text-sm font-medium text-brand-800">
					...
					<div className="flex items-center gap-2">
						<input
							...
							disabled={isLoading}
						/>
						<label htmlFor="editar-activo" className="text-sm font-medium text-brand-800">
							Producto activo
						</label>
					</div>
